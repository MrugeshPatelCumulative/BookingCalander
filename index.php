      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-5">
            ...
            <div class="row" id="bookedDateAndTime" style="display:none;">
              <div class="col">Time: <span id="afterBookedTime"></span></div>
              <div class="col">Date: <span id="afterBookedDate"></span></div>
            </div>
            <div class="row">
              <div class="col">
  ...
  <footer>
    ...
    <script type="text/javascript">
      ...
      function gotoRegister(time,selectDate){
        $('#backButton').show();
        $('#bookingForm').show();
        $('#bookedDateAndTime').show();

        $('#calanderDiv').hide();
        $('#timeDiv').hide();
        $('#startAndEnd').hide();

        $('#afterBookedTime').html(time);
        $('#afterBookedDate').html(selectDate);
      }
      function gotoMainPage(){
        $('#backButton').hide(); 
        $('#bookingForm').hide(); 
        $('#bookedDateAndTime').hide();
      ...
      $('#saveData').on('click',function(){
        ...
        let time = $('#afterBookedTime').html();
        let selectDate = $('#afterBookedDate').html();
        if(count > 0){
          return false;
        }
        $.ajax({
